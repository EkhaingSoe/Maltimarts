...
const Header = () => {
  ...
  return (
    <header
      className="header px-4  h-[50px] lg:px-0 w-full flex items-center  bg-white ]"
      ref={headerRef}
    >
      <div className="container flex justify-between items-center mx-auto">
        ...
        <div className="nav__icons   flex items-center gap-5">
          <span className="fav__icon relative">
            ...
            <span className="badge  absolute w-4 h-4 -top-2 -right-2 flex items-center justify-center  bg-primary text-white rounded-full ">
              1
            </span>
          </span>
          <Link to="/cart">
